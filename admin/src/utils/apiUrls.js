...
export const apiGetCollectionConfig = (collectionName) =>
  `/${pluginId}/collection-config/${collectionName}`;
export const apiSaveCollectionConfig = (collectionName) =>
  `/${pluginId}/collection-config/${collectionName}`;
...
export const apiRequestCollectionIndexing = (collectionName) =>
  `/${pluginId}/collection-reindex/${collectionName}`;
export const apiRebuildCollectionIndex = (collectionName) =>
  `/${pluginId}/collection-rebuild/${collectionName}`;
